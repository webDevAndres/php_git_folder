...
$queryAllHours = 'SELECT avail_id,avail_days,slot_avail,slot_open FROM eny_avail WHERE slot_open="no" ORDER BY avail_id ASC';
...
<div class="container">
  ...
  <ul class="pagination">
    ...
    <thead>
    <tr>
      <th scope="col">Available times for the week of Monday December 11th, 2017</th>
    </tr>
  </thead>
