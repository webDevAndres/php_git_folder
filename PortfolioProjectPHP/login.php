...
//connect to database
        ...
        $query = "SELECT eny_user_name,eny_user_password FROM eny_user WHERE eny_user_name = :eny_user_name AND eny_user_password = :eny_user_password";

//prepare the query and bind parameters
        $stmt = $conn->prepare($query);
        $stmt->bindValue(':eny_user_name', $inUsername, PDO::PARAM_STR);
        $stmt->bindValue(':eny_user_password', $inPassword, PDO::PARAM_STR);
        $stmt->execute();
...
<div class="row">
    <div class="col-sm-12">
            ...
            if ($_SESSION['validUser'] == "yes") {
            ?>
            <h3>Eny Administrator Systems</h3>
                    <p><a href="addAvailTimes.php">Update Available times</a></p>
                    <p><a href="adminApptView.php">Appointments</a></p>
                    <p><a href="logout.php">Logout of Admin System</a></p>  
            <?php
            } else {
                ?>
               <?php $_SESSION['validUser'] = "no" ?>
                <h2>Eny administrator systems</h2>
